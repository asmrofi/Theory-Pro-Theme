								...
								<div class="vc_fields vc_clearfix">
									...
									<div class="vc_type vc_param-field">
										...
										<select name="type">
											...
											<option
												value="textfield"<?php echo '<# if (type === "textfield") { #> selected<# } #>' ?>><?php _e( 'Textfield', 'js_composer' ) ?>
                                            </option>
                                            
                                            <option
												value="colorpicker"<?php echo '<# if (type === "colorpicker") { #> selected<# } #>' ?>><?php _e( 'Color picker', 'js_composer' ) ?>
                                            </option>
